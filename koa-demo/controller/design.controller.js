...
class DesignController extends BasController {
    constructor(name) {
        ...
        this.addRouter('get', '/design/list', this.handlerwarp(this.getList,{title:1,desc:1,author:1,smImg:1,fullImg:1,type:1},true));
        this.addRouter('get', '/design', this.handlerwarp(this.getItem,{title:1,desc:1,author:1,smImg:1,fullImg:1,type:1}),true);
